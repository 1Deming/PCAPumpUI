...
#define INFUSION_LOG_MAX_SIZE     1000
#define ALARM_LOG_MAX_SIZE 	  	  1000
#define INTERNAL_LOG1_MAX_SIZE 	  1000
#define INTERNAL_LOG2_MAX_SIZE 	  1002


//or the log max size will >= xxx
#ifndef INFUSION_LOG_MAX_SIZE 
#define INFUSION_LOG_MAX_SIZE_AT_LEAST 1000
#endif

#ifndef ALARM_LOG_MAX_SIZE 
#define ALARM_LOG_MAX_SIZE_AT_LEAST    1000
#endif

#ifndef INTERNAL_LOG1_MAX_SIZE 
#define INTERNAL_LOG1_MAX_SIZE_AT_LEAST 1000
#endif

#ifndef INTERNAL_LOG2_MAX_SIZE 
#define INTERNAL_LOG2_MAX_SIZE_AT_LEAST 1002
#endif
...
typedef enum
{
	kLOG_EVENT_TYPE_INFO     =         	 0x00000001,
	kLOG_EVENT_TYPE_WARN     =           0x00000002,
	kLOG_EVENT_TYPE_ERROR    =           0x00000004,
	//#define LOG_EVENT_TYPE_FATAL		 0x00000010
	kLOG_EVENT_TYPE_INFUSION =           0x00000010,
	kLOG_EVENT_TYPE_ALARM    =			 0x00000020,
	kLOG_EVENT_TYPE_ALL   	 =			 0xFFFFFFFF,
}EventType;
...
typedef enum {
	//infusion log
	kLogEventInfusionStart=0,
	kLogEventBolusStart,
	kLogEventBolusEnd,	
	kLogEventBaseStart,
	kLogEventBaseEnd,
	kLogEventDelayDose,
	kLogEventInfusionEnd,


	//alarm log
	kLogEventAlarmStart = 1000,
	kLogEventAlarm,
	kLogEventAlarmEnd,

	//internal log1
	kLogEventInternal1Start = 2000,
	kLogEventPostReport,
	kLogEventSwitchSet,
	kLogEventDoseParaSet,
	kLogEventFirstLoadDose,
	kLogEventReset,
	kLogEventInteranl1End,

	//internal log2
	kLogEventInternal2Start = 3000,
	kLogEventBaseSet12s,
	kLogEventBaseSet16,
	kLogEventBaseSet12e,
	kLogEventTempSet12s,
...
/*
	...
	//param1:year
	kLogEventSetYear,
	//params: pressure_adc, adc_when_install, occlusion count
