...
#define SSZ_IOCTL_ERASE_ONE_UNIT	-11 //erase one unit at the address,  param[in] is address: &int32_t
...
// return the internal data pointer address, param[out]: uint8_t**
#define SSZ_IOCTL_GET_INTERNAL_DATA_POINTER -20
// skip size for read and will return real skip size, param[in out]: int*
#define SSZ_IOCTL_SKIP_READ -21
