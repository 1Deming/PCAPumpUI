...
static int ssz_uart_file_read(struct ssz_file_t* file, void* buff,
...
static int ssz_uart_file_write(struct ssz_file_t* file, const void* buff,
...
static int ssz_uart_file_ctl(struct ssz_file_t* file, int command,
                             void* param) {
	int ret = kSszSuccess;
	(void)param;
	// SszUART* dev = file->dev_data;
...
void ssz_uart_init(SszUART* obj, void* original_dev,
