...
WM_HWIN app_home_02000_create(type_MsgBody4UICtrlMsg *msg) 
{
	...
	g_ui_common_param.child_id[0]  = ud_text_create(130, 2, 32, 16, hWin, WM_CF_SHOW, "123");
	g_ui_common_param.child_id[1] = ud_text_create(130, 25, 32, 16, hWin, WM_CF_SHOW, "456");
	return hWin;
}
