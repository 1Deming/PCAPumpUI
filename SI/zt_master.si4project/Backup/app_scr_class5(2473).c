...
static void _cbDialog(WM_MESSAGE * pMsg) 
{
	...
	switch (pMsg->MsgId) 
	{
		case WM_INIT_DIALOG:
			...
			hWin = TEXT_CreateEx(2, 2, strlen, 14, pMsg->hWin, 
			...
			{//str
				...
				hWin = TEXT_CreateAsChild(rect.x0, rect.y0, rect.x1 - rect.x0 + 1, rect.y1 - rect.y0 + 1, pMsg->hWin, id[i], 
...
//			put_select_arrow(msg->CursorIndex.CursorIndex);
//			put_select_password(msg->CursorIndex.CursorIndex, msg->ditem.DataValArray[0]);
//			break;
//
//		default:
//			break;
//	}
	...
	put_select_password(1,msg->ditem.DataValArray[1]);
	put_select_password(2,msg->ditem.DataValArray[2]);
	put_select_password(3,msg->ditem.DataValArray[3]);
	put_select_arrow(msg->SItem.DataValArray[4]);
