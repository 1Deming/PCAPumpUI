...
#define ID_MINUS_PLUS_IMG_SELECT	(GUI_ID_USER + 0x06)
...
static void move_plus_offset_cusor(int cursor)
{
	...
	hWin = WM_GetDialogItem(ui_get_current_hwin(), ID_MINUS_PLUS_IMG_SELECT);
		...
		switch (pMsg->MsgId) 
		{
			case WM_INIT_DIALOG:
				...
				hWin = IMAGE_CreateEx(get_image_x(0), 52, bitmap->XSize, bitmap->YSize, pMsg->hWin, 
									  WM_CF_SHOW,  IMAGE_CF_AUTOSIZE, ID_MINUS_PLUS_IMG_SELECT);
