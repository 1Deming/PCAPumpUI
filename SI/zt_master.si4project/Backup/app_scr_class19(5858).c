...
#define MessageID3			(GUI_ID_USER + 0x04)
...
static void push_message(uint8_t UIID,uint8_t Forword,uint8_t backword,uint8_t seriesID ,uint8_t seriesIDall,uint8_t cursorIndex)
{
	...
	TEXT_SetText(WM_GetDialogItem(g_ui_common_param.win_id, MessageID2), p);	
