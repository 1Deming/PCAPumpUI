...
{
	WM_HWIN hItem;
	//GUI_RECT rect1 = {16, 16, 127, 32};
	//GUI_RECT rect2 = {32, 36, 127, 52};
	switch (pMsg->MsgId) 
	{
		case WM_INIT_DIALOG:
			hItem = pMsg->hWin;
		...
		case WM_PAINT:
			...
			//GUI_DispStringInRect(get_string(kStrTimeTip1), &rect1, GUI_TA_LEFT|GUI_TA_VCENTER);
			//GUI_DispStringInRect(get_string(kStrTimeTip2), &rect2, GUI_TA_LEFT|GUI_TA_VCENTER);
			break;  
		default:
			  WM_DefaultProc(pMsg);
			  break;
