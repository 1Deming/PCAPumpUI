...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  {WINDOW_CreateIndirect, "app_scr_class18", ID_WINDOW_0, 0, 0, 256, 64, 0, 0x0, 0},
...
static void put_message(double data ,uint8_t unit,uint8_t seriesID ,uint8_t seriesIDall  ,uint8_t cursor)
{		
	char p[30];
    const char *ptr;
    WM_HWIN hWin;
...
static void _cbDialog(WM_MESSAGE * pMsg)
{
	...
	switch (pMsg->MsgId) 
	{
		...
		case WM_PAINT:
			...
			ptr = get_string(kStrConcentrationSet);
