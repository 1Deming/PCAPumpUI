...
WM_HWIN app_home_02000_create(type_MsgBody4UICtrlMsg *msg) 
{
	...
	g_ui_common_param.child_id[0]  = widget_text_create(130, 2, 32, 16, hWin, WM_CF_SHOW, "");
	g_ui_common_param.child_id[1] = widget_text_create(130, 25, 32, 16, hWin, WM_CF_SHOW, "");
	return hWin;
}
...
int app_home_02000_update(WM_HWIN hwin, type_MsgBody4UICtrlMsg *msg)
{
	...
	switch(msg->OpMethod)
	{
		case SCR_CURSER_MOVE:
			...
			sprintf(p, "%d", msg->CursorIndex);
			//ud_text_set_str(g_ui_common_param.child_id[0], p);
