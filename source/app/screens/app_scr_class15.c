...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  {WINDOW_CreateIndirect, "app_scr_class15", ID_WINDOW_0, 0, 0, 256, 64, 0, 0x0, 0},
...
static void put_message(uint8_t mainVersion ,uint8_t slaverVersion,uint8_t version)
{		
	char p[30];
    const char *ptr;
    WM_HWIN hWin;
    ...
    sprintf(p, "V%02d.%02d.%02d", mainVersion,slaverVersion,version);
...
static void _cbDialog(WM_MESSAGE * pMsg)
{
	...
	switch (pMsg->MsgId) 
	{
		...
		case WM_PAINT:
			...
			ui_rect_init_by_size(rect, 2, 1, 100, 14);
